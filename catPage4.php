    ...
    <body>
        ...
        $i=1;
          include 'dbConnection.php';
           $productIndexLast="SELECT * FROM category4 ORDER BY categoryIndex DESC LIMIT 1  ";
            ...
            echo '<div style="margin-left:500px"><h1>CATEGORY 4</h1><br><br></div>';
           while($i<=$index){
       echo '<div class="row">
            <div class="col-md-3 ">';
                ...
                $sql="select * from category4 where categoryIndex='$i'";
