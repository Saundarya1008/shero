    ...
    <body>
        ...
        $i=1;
          include 'dbConnection.php';
           $productIndexLast="SELECT * FROM category1 ORDER BY categoryIndex DESC LIMIT 1  ";
       ...
       echo '<div class="row">
            <div class="col-md-3 ">';
                ...
                $sql="select * from category1 where categoryIndex='$i'";
               ...
               $rows=$conn->query($sql);
                ...
                $selProductQty=$row1['selProductQty'];
                echo '<div class="polaroid">
                 <img src='.$row1['selProductImage'].' class="img-responsive" style="width:100%;height:200px" alt="Image">
                  ...
                  <p>IN STOCK:'.$row1['selProductQty'].'</p>  ';  
                      ?>
         <div class="container-fluid">
                  <form action="Cart.php" method="post" >
                     
                      <input type="hidden" name="productCode" value="<?php echo $selProductCodeNow;?>">
                      <input type="hidden" name="inStock" value="<?php echo $selProductQty; ?>">
                      <input type="number" name="qty" min="1" style="width:60px;margin-left:-15px"><br><br>
                     
                
                        <button type="submit"  class="btn btn-success" name="add_to_cart" style="margin-left:-28px" >Add to Cart</button>    
