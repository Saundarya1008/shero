...
<html>
  ...
  <style>
   ...
   echo '</table>';
   echo '<form class="form-horizontal" action="updateRateDB.php"  method="post">';
   
           echo '<div class="form-group col-sm-12">';
           echo '<div class="col-sm-8"></div>';
           echo '<div class="col-sm-4">';
           echo ' <label class="control-label col-sm-5" for="qty" style="color:white">NEW RATE:</label>';
           echo ' <div class="col-sm-4"><input type="text" name="updateSelRate" placeholder="change rate" ></div></div></div>';
